...
export default function CoreValues() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Prominent Dual-Column Scroll-Driven Up and Down Parallax Animation
      ...
      // Dynamic tilt and micro-travel response on individual cards on scroll
      if (card1Ref.current) {
...
console.log('CoreValues.jsx updated with dynamic up & down scroll animation!');
...
.core-values-section {
  ...
  width: 100%;
  min-height: 110vh;
  padding-block: clamp(4rem, 9vh, 9rem);
...
/* Ambient Floating Bobbing Animations */
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  console.log('index.css updated with enhanced up/down scroll and float animations!');
} else {
