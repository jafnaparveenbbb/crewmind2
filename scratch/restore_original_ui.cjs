...
console.log('HorizontalStats.jsx written successfully with original UI (images removed)!');
...
const originalCleanHorizontalCss = `/* ==========================================================================
   HORIZONTAL STATS (480vh pinned)
   ========================================================================== */
...
if (startIdx !== -1 && endIdx !== -1) {
  const updatedCss = css.substring(0, startIdx) + originalCleanHorizontalCss + css.substring(endIdx);
  fs.writeFileSync(indexCssPath, updatedCss, 'utf8');
  console.log('index.css updated successfully with original clean UI!');
} else {
