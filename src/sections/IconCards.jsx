...
export default function IconCards() {
  ...
  const cardsData = [
    ...
    },
    {
      ...
      icon: (
        <svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
          <circle cx="32" cy="20" r="10" opacity="0.2" fill="currentColor"/>
          <circle cx="32" cy="20" r="10" stroke="currentColor" strokeWidth="1.5"/>
          <path d="M14 52C14 42.0589 22.0589 34 32 34C41.9411 34 50 42.0589 50 52" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M46 22C49.3137 22 52 19.3137 52 16C52 12.6863 49.3137 10 46 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
          <path d="M54 44C56.5 45.5 58 48 58 52" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
      )
    }
  ];
