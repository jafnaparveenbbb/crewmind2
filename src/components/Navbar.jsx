...
export default function Navbar({ onNavigate }) {
  ...
  return (
    <>
      ...
      {/* Responsive mobile burger drawer */}
      <div className="burger">
        <div className="burger__list">
          <a href="#solutions" className="burger__item" onClick={closeBurger}>Solutions</a>
          <a href="#about" className="burger__item" onClick={closeBurger}>About</a>
          <a href="#insights" className="burger__item" onClick={closeBurger}>Insights</a>
          <a href="#thought-leadership" className="burger__item with-arrow" onClick={closeBurger}>
            <span>↳</span>
            <span>Thought Leadership</span>
          </a>
          <a href="#resources" className="burger__item with-arrow" onClick={closeBurger}>
            <span>↳</span>
            <span>Resources</span>
          </a>
          <a href="#newsroom" className="burger__item with-arrow" onClick={closeBurger}>
            <span>↳</span>
            <span>Newsroom</span>
          </a>
          <a href="#team" className="burger__item" onClick={closeBurger}>Team</a>
          <a href="#careers" className="burger__item" onClick={closeBurger}>Careers</a>
          <a href="#contact" className="burger__item" onClick={closeBurger}>Contact Us</a>
        </div>
        <div className="burger__socials">
          <a href="https://www.instagram.com/significohealth/" target="_blank" rel="noreferrer" className="footer__social--item">Instagram</a>
          <a href="https://www.linkedin.com/company/significo-health/" target="_blank" rel="noreferrer" className="footer__social--item">LinkedIn</a>
          <a href="https://www.youtube.com/@significo_" target="_blank" rel="noreferrer" className="footer__social--item">YouTube</a>
          <a href="https://twitter.com/significohealth" target="_blank" rel="noreferrer" className="footer__social--item">Twitter</a>
        </div>
      </div>
    </>
  );
